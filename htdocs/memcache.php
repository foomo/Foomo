...
/**
 * get the servers from the memcache persistor config
 * // added by bostjanm 29.9.2010
 */
$persistor = \Foomo\Cache\Manager::getFastPersistor();
if ($persistor instanceof \Foomo\Cache\Persistence\Fast\MemcachePersistor) {
	$MEMCACHE_SERVERS = array();
	$MEMCACHE_SERVERS[] = $persistor->serverConfig['host'] . ':' . $persistor->serverConfig['port'];
}
